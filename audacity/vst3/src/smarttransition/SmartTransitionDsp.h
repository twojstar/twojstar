...
private:
    ...
    [[nodiscard]] Candidate scoreCandidate(std::int64_t anchor, std::size_t channels) const noexcept;
    ...
    [[nodiscard]] SmartEditPlan makePlan(const Candidate& candidate) const noexcept;
    ...
    std::size_t competitionRadius_{104};
